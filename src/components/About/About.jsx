    ...
    <div className='About'>
        ...
        <div className='About-sections'>
          <div className='about-left'>
            <img className='about-pic' src={pic} alt="" />
          </div>
          <div className='about-right'>
            <div className='about-para'>
              <p>As a MERN stack developer, I bring a strong foundation in JavaScript, React, Node.js, Express, and MongoDB. While I may be new to the field, my dedication, adaptability, and willingness to learn make me an asset to any team.</p>
